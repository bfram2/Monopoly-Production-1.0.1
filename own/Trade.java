...
public class Trade extends JFrame implements ActionListener{
	...
	public Trade(Players play1, Players play2, Players [] playArr, Properties prop, Properties p, Properties [] propArr){
		        ...
		        String input = (String) JOptionPane.showInputDialog(null, "Player "+currentPlayer.getPlayerNumber() +" what property would you like to trade for" + currentProperty.getName() + "?","Properties", JOptionPane.QUESTION_MESSAGE, null,choices,choices[1]); // Initial choice
		 		...
		 		if(secondProperty.getOwner() == 0){
					...
					close.addActionListener(this);
		 			...
		 			statustxt = "Player " +currentPlayer + " would like to trade with "+ currentProperty.getName() + " for" + secondProperty.getName()+",if " +secondPlayer.getName() + " would like to trade press Trade on the MainBoard";;	
